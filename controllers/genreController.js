...
const getAllRecords = async (req, res) => {
    ...
    res.render("records", {title: "All Records", records: result.rows, amount: result.rowCount})
}
...
const getRecordsInGenre = async (req, res) => {
    ...
    res.render("records", {title: ` ${genreName} Records`, records: result.rows, amount: result.rowCount});
}
